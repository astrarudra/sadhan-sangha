...
export const YTPlaylistBox = ({data: {l, t, st}}) => {
    return <div  onClick={() => window.open(ytList + l, "_blank")} className="iframe-header font-freeman" style={{borderRadius: '12px', cursor: 'pointer', marginBottom: '5px'}}>
        <ResponsiveTypography mdText={t} xsText={st} className="font-freeman"/>
